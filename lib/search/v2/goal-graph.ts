...
export const SEED_GOAL_TRAIT_MAP: Omit<GoalTraitMapRow, "goal_embedding">[] = [
  ...
  {
    goal_id: "heart_health",
    goal_phrase: "heart health cholesterol",
    display_name: "Heart health",
    trait_weights: {
      low_saturated_fat: 0.25,
      low_sodium: 0.2,
      healthy_fats: 0.2,
      fiber_density: 0.2,
      whole_food: 0.15,
  ...
  {
    goal_id: "pregnancy",
    goal_phrase: "pregnancy prenatal nutrition",
  ...
  {
    goal_id: "keto",
    goal_phrase: "keto low carb",
    display_name: "Keto / low-carb",
    trait_weights: {
      low_carb: 0.45,
      healthy_fats: 0.2,
      protein_density: 0.2,
  ...
  {
    goal_id: "energy_fatigue",
    goal_phrase: "energy anti fatigue",
    display_name: "Energy / anti-fatigue",
    trait_weights: {
      iron_rich: 0.25,
      slow_energy: 0.25,
      vitamin_rich: 0.2,
  ...
  {
    goal_id: "skin_hair",
    goal_phrase: "skin and hair health",
    display_name: "Skin & hair",
    trait_weights: {
      antioxidant: 0.3,
      vitamin_rich: 0.3,
      healthy_fats: 0.2,
  ...
  {
    goal_id: "bone_health",
    goal_phrase: "bone health strength",
  ...
  {
    goal_id: "gut_digestion",
    goal_phrase: "gut health digestion probiotics",
    display_name: "Gut health / digestion",
    trait_weights: {
      gut_health: 0.35,
      fiber_density: 0.30,
      clean_label: 0.15,
  ...
  {
    goal_id: "anemia",
    goal_phrase: "anemia iron deficiency hemoglobin",
  ...
  {
    goal_id: "bp_hypertension",
    goal_phrase: "blood pressure hypertension low sodium",
    display_name: "Blood pressure",
    trait_weights: {
      low_sodium: 0.40,
      low_saturated_fat: 0.20,
      fiber_density: 0.15,
      whole_food: 0.15,
      clean_label: 0.10,
    },
  ...
  {
    goal_id: "vegan_plant",
    goal_phrase: "vegan plant based dairy free",
    display_name: "Vegan / plant-based",
    trait_weights: {
      whole_food: 0.30,
      fiber_density: 0.25,
      clean_label: 0.20,
      protein_density: 0.15,
      low_saturated_fat: 0.10,
    },
    source: "seed",
    confidence: 1,
    support_count: 0,
  ...
  {
    goal_id: "hydration",
    goal_phrase: "hydration electrolytes summer drinks",
  ...
  {
    goal_id: "energy_boost",
    goal_phrase: "energy boost pre workout morning",
...
export async function resolveGoalWeights(
  ...
  const queryEmbed = await embedText(phrase, "query");
...
export async function persistLearnedGoal(
  ...
  const goal_embedding = await embedText(goalPhrase, "document");
  try {
